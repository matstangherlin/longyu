...
| Frases inéditas cobradas | 24 |
| Transfer guided / supported / question | 128 / 0 / 0 |
...
- **p4-char-bu** · `frame_woyouge` · guided · âncora 我有三个朋友 → `我有五个朋友。`
- **p4-char-shi** · `frame_woyouge` · guided · âncora 我有三个朋友 → `我有四个朋友。`
- **p4-char-wo** · `frame_woyouge` · guided · âncora 我有三个朋友 → `我有一个朋友。`
- **p4-char-ni** · `frame_woyouge` · guided · âncora 我有三个朋友 → `我有四个朋友。`
- **l14-pecas-natureza** · `frame_woyouge` · guided · âncora 我有三个朋友 → `我有一个朋友。`
- **l14-frase-minima** · `frame_woyouge` · guided · âncora 我有三个朋友 → `我有四个朋友。`
- **l6-rev** · `frame_woyouge` · guided · âncora 我有三个朋友 → `我有四个朋友。`
- **l7-rev** · `frame_woyouge` · guided · âncora 我有三个朋友 → `我有五个朋友。`
- …mais 33.
