        ...
        lessons: [
          ...
          ...PHASE3_SURVIVAL_AFTER_WOHENHAO,
          {
            ...
            steps: [
              ...
              listen("请慢一点", "qǐng màn yìdiǎn", "Por favor, mais devagar"),
              flash("qingmanyidian"),
              dialogue(
                "Mais devagar",
                "A pessoa fala rápido. O que você pede?",
                "请慢一点",
                ["请慢一点", "再见", "太贵了", "我很好"],
        ...
        lessons: [
          {
            ...
            reviewItems: ["chunk:zheshibaba", "chunk:zheshimama", "char:jia", "chunk:woyoujiejie"],
            steps: [
              flash("zheshibaba"),
              flash("zheshimama"),
              flash("woyoujiejie"),
              flash("woyouyigegege"),
              flash("womeiyoujiejie"),
              listen("这是我爸爸", "zhè shì wǒ bàba", "Este é meu pai."),
              listen("这是我妈妈", "zhè shì wǒ māma", "Esta é minha mãe."),
              listen("我有一个哥哥", "wǒ yǒu yí gè gēge", "Tenho um irmão mais velho."),
              listen("我没有姐姐", "wǒ méiyǒu jiějie", "Não tenho irmã mais velha."),
              imageChoice(
                "choose_hanzi",
                "father",
        ...
        lessons: [
          ...
          },
          {
            ...
            steps: [
              ...
              listen("我要米饭", "wǒ yào mǐfàn", "Quero arroz (米饭)."),
              listen("我想吃米饭", "wǒ xiǎng chī mǐfàn", "Quero comer arroz."),
              listen("我要菜", "wǒ yào cài", "Quero verdura."),
              listen("我想喝水", "wǒ xiǎng hē shuǐ", "Quero beber água."),
              listen("我要一杯茶", "wǒ yào yì bēi chá", "Quero um copo de chá."),
              listen("不要辣", "búyào là", "Sem pimenta."),
              listen("服务员！", "fúwùyuán!", "Garçom!"),
              listen("买单", "mǎidān", "A conta, por favor."),
              ...
              dialogue(
                "Sem pimenta",
                "O prato pode vir picante. Você não quer. O que diz?",
                "不要辣",
                ["不要辣", "买单", "你好", "太贵了"],
                "不要辣 pede sem pimenta — pedido real de restaurante.",
                "Garçom"
              ),
              dialogue(
                "A conta",
                "Já comeu. Como pede a conta?",
                "买单",
                ["买单", "不要辣", "再见", "我很好"],
                "买单 pede a conta no restaurante.",
                "Garçom"
              ),
          ...
          withLessonDefaults({
            ...
            steps: [
              ...
              dialogue(
                "Reserva",
                "Você chegou ao hotel com reserva. O que diz?",
                "我有预订",
                ["我有预订", "买单", "不要辣", "再见"],
              ...
              dialogue(
                "Passaporte",
                "A recepção pede documento. O que você diz ao entregar?",
                "这是我的护照",
                ["这是我的护照", "我很好", "太贵了", "菜单"],
              ...
              dialogue(
                "Quarto",
                "Você quer achar o quarto. O que pergunta?",
                "我的房间在哪里？",
                ["我的房间在哪里？", "你好吗？", "买单", "太贵了"],
        ...
        lessons: [
          ...
          },
          {
            ...
            steps: [
              ...
              listen("地铁", "dìtiě", "metrô"),
              listen("火车", "huǒchē", "trem"),
              listen("公交车", "gōngjiāochē", "ônibus"),
              flash("ditie"),
              flash("huoche"),
              flash("gongjiaoche"),
              flash("wozuoditie"),
              flash("wozuochuzuche"),
              flash("ditiezhanzainali"),
              listen("我坐地铁", "wǒ zuò dìtiě", "Vou de metrô."),
              listen("地铁站在哪里？", "dìtiězhàn zài nǎlǐ?", "Onde fica a estação de metrô?"),
              dialogue(
                "Metrô",
                "Você vai de metrô. O que diz?",
                "我坐地铁",
                ["我坐地铁", "买单", "不要辣", "我很好"],
                "我坐地铁 = vou de metrô."
              ),
          ...
          },
          {
            ...
            steps: [
              ...
              freeProduction({
                ...
                productionOpen: true,
                productionHintPt: "Fale, escreva em hànzì ou em pinyin.",
                productionExamples: [{ hanzi: "我有预订", pinyin: "wǒ yǒu yùdìng" }],
              }),
              freeProduction({
                title: "Onde fica o quarto?",
                situationPt: "Você não encontra o quarto. Pergunte onde ele fica, sem alternativas.",
                ...
                productionOpen: true,
                productionHintPt: "Fale, escreva em hànzì ou em pinyin.",
                productionExamples: [{ hanzi: "我的房间在哪里？", pinyin: "wǒ de fángjiān zài nǎlǐ?" }],
              }),
          ...
          },
          {
            ...
            steps: [
              ...
              freeProduction({
                ...
                expected: "这是我的护照",
                accepts: ["这是我的护照", "这是我的护照。", "护照"],
                productionGoal: "request_item",
                productionOpen: true,
                productionHintPt: "Fale, escreva em hànzì ou em pinyin.",
                productionExamples: [{ hanzi: "这是我的护照", pinyin: "zhè shì wǒ de hùzhào" }],
              }),
              freeProduction({
                title: "Pergunte o portão",
                situationPt: "Você precisa embarcar. Pergunte onde fica o portão, sem alternativas.",
                expected: "登机口在哪里？",
                accepts: ["登机口在哪里？", "登机口在哪里", "登机口呢？"],
                productionGoal: "ask_location",
                productionOpen: true,
                productionHintPt: "Fale, escreva em hànzì ou em pinyin.",
                productionExamples: [{ hanzi: "登机口在哪里？", pinyin: "dēngjīkǒu zài nǎlǐ?" }],
              }),
              freeProduction({
                title: "Peça para repetir",
                situationPt: "Você não entendeu o número do portão. Peça para repetir, sem alternativas.",
                expected: "请再说一遍",
                accepts: ["请再说一遍", "请再说一遍。", "请慢一点", "请慢一点。"],
                productionGoal: "ask_location",
                productionOpen: true,
                productionHintPt: "请再说一遍 ou 请慢一点 — as duas pedem reparo.",
                productionExamples: [
          ...
          },
          {
            ...
            steps: [
              ...
              freeProduction({
                ...
                expected: "机场在哪里？",
                accepts: ["机场在哪里？", "机场在哪里", "机场呢？"],
                productionGoal: "ask_location",
                productionOpen: true,
                productionHintPt: "A mesma pergunta de lugar, agora com 机场.",
                productionExamples: [{ hanzi: "机场在哪里？", pinyin: "jīchǎng zài nǎlǐ?" }],
              }),
              mapDirection(
                "Do hotel à estação",
                "酒店",
              ...
              freeProduction({
                ...
                expected: "机场在哪里？",
                accepts: ["机场在哪里？", "机场在哪里", "我要去机场", "我要去机场。"],
                productionGoal: "state_destination",
                productionOpen: true,
                productionHintPt: "机场在哪里？ já foi ensinada. Não invente frase nova se não precisar.",
                productionExamples: [{ hanzi: "机场在哪里？", pinyin: "jīchǎng zài nǎlǐ?" }],
              }),
              listenSelect(
                "Qual instrução o áudio deu?",
