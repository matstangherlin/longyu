...
const PHASE1_BOOTSTRAP_LESSONS: Lesson[] = [
  ...
  microLesson({
    ...
    title: "O que é hànzì?",
    skill: "hanzi",
    libraryItems: ["char:mu", "char:ri", "char:yue", "char:ren", "char:kou", "char:shan", "char:shui", "char:huo", "char:da", "char:xiao", "char:zhong", "char:lin", "char:sen", "char:ming", "char:hao"],
    reviewItems: ["char:mu", "char:ri", "char:yue", "char:ren", "char:kou", "char:shan", "char:shui", "char:huo", "char:da", "char:xiao", "char:zhong", "char:lin", "char:sen", "char:ming", "char:hao"],
    steps: [
      ...
      },
      {
        kind: "hanzi_build",
        title: "Monte 林",
        builderId: "hb-lin-components",
        prompt: "木 + 木 forma qual ideia visual?",
        sourceMeaning: "duas árvores",
        targetParts: ["木", "木"],
        bank: ["木", "日", "月"],
        correctAnswer: "林",
        explanation: "木 + 木 forma 林: bosque. Peças repetidas continuam sendo peças diferentes na montagem.",
      },
      {
        kind: "hanzi_build",
        title: "Monte 明",
        builderId: "hb-ming-components",
        prompt: "日 + 月 forma qual caractere?",
        sourceMeaning: "sol + lua",
        targetParts: ["日", "月"],
        bank: ["月", "口", "日", "木"],
        correctAnswer: "明",
        explanation: "日 + 月 forma 明: claro/brilhante. A composição ajuda a memorizar a forma.",
      },
      fillBlank(
        "Complete a lógica",
        ...
        "",
        ["森", "林", "明", "好"],
        "Três árvores formam 森, floresta densa."
      ),
      dialogue(
      ...
      hanziBuild("hb-zhong-fragments", "Monte 中", "Monte o hànzì de centro.", "中", "meio; centro"),
      dialogue(
        "Revisão",
        "Hànzì é o quê?",
      ...
      dialogue(
        ...
        "Nem todo caractere moderno é desenho. 妈, por exemplo, usa 女 como pista de sentido e 马 como pista sonora.",
        "Escolha"
      ),
      {
        kind: "hanzi_build",
        ...
        sourceMeaning: "mulher + criança",
        targetParts: ["女", "子"],
        bank: ["子", "女", "口", "马"],
        correctAnswer: "好",
        explanation: "女 + 子 é uma memória visual para 好: bom; bem.",
      },
    ],
  }),
];
