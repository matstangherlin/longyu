...
export const CHUNKS: Chunk[] = [
  ...
  { id: "qingwenjiwei", hanzi: "请问几位？", pinyin: "qǐng wèn jǐ wèi?", meaningPt: "Quantas pessoas, por favor?", literalPt: "por favor perguntar quantas pessoas", tags: ["comida", "pergunta"], domain: "comida", level: "survival" },
  { id: "yiwei", hanzi: "一位", pinyin: "yí wèi", meaningPt: "Uma pessoa (no restaurante).", literalPt: "uma pessoa", tags: ["comida"], domain: "comida", level: "survival" },
  { id: "liangwei", hanzi: "两位", pinyin: "liǎng wèi", meaningPt: "Duas pessoas (no restaurante).", literalPt: "duas pessoas", tags: ["comida"], domain: "comida", level: "survival" },
  { id: "woyaocaidan", hanzi: "我要菜单", pinyin: "wǒ yào càidān", meaningPt: "Quero o cardápio.", literalPt: "eu quero cardápio", tags: ["comida"], domain: "comida", level: "survival" },
  { id: "buyaole", hanzi: "不要了", pinyin: "bú yào le", meaningPt: "Não quero mais.", literalPt: "não querer (já)", tags: ["comida"], domain: "comida", level: "survival" },
  { id: "liangbeishui", hanzi: "两杯水", pinyin: "liǎng bēi shuǐ", meaningPt: "Dois copos de água.", literalPt: "dois copos água", tags: ["comida", "bebida"], domain: "bebida", level: "survival" },
  ...
  { id: "zhujiwan", hanzi: "住几晚？", pinyin: "zhù jǐ wǎn?", meaningPt: "Quantas noites?", tags: ["survival", "hotel"], domain: "sobrevivencia", level: "survival" },
  { id: "sanlingwu", hanzi: "三零五", pinyin: "sān líng wǔ", meaningPt: "Trezentos e cinco (número falado).", tags: ["survival", "hotel", "numero"], domain: "sobrevivencia", level: "survival" },
  { id: "dengjikou", hanzi: "登机口", pinyin: "dēngjīkǒu", meaningPt: "Portão de embarque.", tags: ["aeroporto", "placa"], domain: "transporte", level: "survival" },
