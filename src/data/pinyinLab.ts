...
export const PINYIN_INITIALS: PinyinInitial[] = [
  ...
  { id: "j", label: "j", approxPt: "africada sem sopro; língua alta e bem à frente (não é o dj do português)", example: { hanzi: "家", pinyin: "jiā", meaningPt: "casa; família" } },
  { id: "q", label: "q", approxPt: "africada com sopro; língua alta e bem à frente (não é só um tch)", example: { hanzi: "请", pinyin: "qǐng", meaningPt: "por favor" } },
  { id: "x", label: "x", approxPt: "fricativa suave; língua alta e bem à frente (não é o chi do português)", example: { hanzi: "学", pinyin: "xué", meaningPt: "aprender" } },
  ...
  { id: "z", label: "z", approxPt: "africada “ts” sem sopro (não é o z de zebra)", example: { hanzi: "在", pinyin: "zài", meaningPt: "estar em" } },
