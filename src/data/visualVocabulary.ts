...
export const VISUAL_CONCEPTS: VisualConcept[] = [
  ...
  // ————— Ambientes e cotidiano —————
  { id: "bathroom", charId: "v_xishoujian", hanzi: "洗手间", pinyin: "xǐshǒujiān", meaningPt: "banheiro", category: "places", imageSrc: "places/bathroom.webp", imageAltPt: "Ilustração em corte de um banheiro com vaso sanitário e pia", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "transparent", subjectCount: 1, sceneTags: ["places", "home", "room"], emoji: "🚻", afterUnitIndex: 12 },
  ...
  { id: "hotel", charId: "v_jiudian", hanzi: "酒店", pinyin: "jiǔdiàn", meaningPt: "hotel", category: "places", imageSrc: "places/hotel.webp", imageAltPt: "Ilustração de um hotel moderno com entrada e carrinho de bagagem", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "transparent", subjectCount: 1, sceneTags: ["places", "hotel", "survival"], emoji: "🏨", afterUnitIndex: 12 },
  ...
  { id: "airport", charId: "v_jichang", hanzi: "机场", pinyin: "jīchǎng", meaningPt: "aeroporto", category: "places", imageSrc: "places/airport.webp", imageAltPt: "Ilustração de um aeroporto com terminal, torre e avião", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "transparent", subjectCount: 1, sceneTags: ["places", "travel", "transport"], emoji: "🛫", afterUnitIndex: 12 },
  ...
  { id: "taxi", charId: "v_chuzuche", hanzi: "出租车", pinyin: "chūzūchē", meaningPt: "táxi", category: "objects", imageSrc: "transport/taxi.webp", imageAltPt: "Ilustração de um táxi amarelo com luz no teto", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "transparent", subjectCount: 1, sceneTags: ["objects", "transport", "survival"], emoji: "🚕", afterUnitIndex: 12 },
  { id: "bus", charId: "v_gongjiaoche", hanzi: "公交车", pinyin: "gōngjiāochē", meaningPt: "ônibus", category: "objects", imageSrc: "transport/bus.webp", imageAltPt: "Ilustração de um ônibus urbano verde-azulado", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "transparent", subjectCount: 1, sceneTags: ["objects", "transport", "survival"], emoji: "🚌", afterUnitIndex: 12 },
  { id: "train", charId: "v_huoche", hanzi: "火车", pinyin: "huǒchē", meaningPt: "trem", category: "objects", imageSrc: "transport/train.webp", imageAltPt: "Ilustração de um trem de passageiros vermelho e creme", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "transparent", subjectCount: 1, sceneTags: ["objects", "transport", "intercity"], emoji: "🚆", afterUnitIndex: 12 },
  { id: "metro", charId: "v_ditie", hanzi: "地铁", pinyin: "dìtiě", meaningPt: "metrô", category: "objects", imageSrc: "transport/metro.webp", imageAltPt: "Ilustração de um metrô verde-azulado saindo de um túnel", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "transparent", subjectCount: 1, sceneTags: ["objects", "transport", "urban"], emoji: "🚇", afterUnitIndex: 12 },
  { id: "airplane", charId: "v_feiji", hanzi: "飞机", pinyin: "fēijī", meaningPt: "avião", category: "objects", imageSrc: "transport/airplane.webp", imageAltPt: "Ilustração de um avião de passageiros creme", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "transparent", subjectCount: 1, sceneTags: ["objects", "transport", "travel"], emoji: "✈️", afterUnitIndex: 12 },
  // ————— Quantidade —————
