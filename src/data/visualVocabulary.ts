...
export const VISUAL_CONCEPTS: VisualConcept[] = [
  // ————— Núcleo original —————
  { id: "person", charId: "ren", hanzi: "人", pinyin: "rén", meaningPt: "pessoa", category: "people", imageSrc: "people/person.svg", imageAltPt: "Ilustração de uma pessoa em fundo neutro", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "neutral", subjectCount: 1, sceneTags: ["people", "person"], emoji: "🧑", afterUnitIndex: 0 },
  ...
  { id: "mouth", charId: "kou", hanzi: "口", pinyin: "kǒu", meaningPt: "boca", category: "people", imageSrc: "people/mouth.svg", imageAltPt: "Ilustração de uma boca humana", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "neutral", subjectCount: 1, sceneTags: ["people", "body"], emoji: "👄", afterUnitIndex: 6 },
  ...
  { id: "big", charId: "da", hanzi: "大", pinyin: "dà", meaningPt: "grande", category: "quantity", imageSrc: "daily-life/big.svg", imageAltPt: "Bola vermelha muito grande ao lado de um cubo pequeno", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "neutral", subjectCount: 2, sceneTags: ["daily-life", "size"], emoji: "⬛", afterUnitIndex: 6 },
  { id: "small", charId: "xiao", hanzi: "小", pinyin: "xiǎo", meaningPt: "pequeno", category: "quantity", imageSrc: "daily-life/small.svg", imageAltPt: "Bola vermelha pequena ao lado de um cubo grande", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "neutral", subjectCount: 2, sceneTags: ["daily-life", "size"], emoji: "▫️", afterUnitIndex: 6 },
  // ————— Pessoas e família —————
  { id: "woman", charId: "nv", hanzi: "女", pinyin: "nǚ", meaningPt: "mulher", category: "people", imageSrc: "people/woman.svg", imageAltPt: "Ilustração de uma mulher de cabelo comprido", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "neutral", subjectCount: 1, sceneTags: ["people", "person"], emoji: "👩", afterUnitIndex: 8 },
  { id: "child", charId: "zi", hanzi: "子", pinyin: "zǐ", meaningPt: "criança", category: "people", imageSrc: "people/child.svg", imageAltPt: "Ilustração de uma criança pequena brincando com uma bola", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "neutral", subjectCount: 1, sceneTags: ["people", "family"], emoji: "🧒", afterUnitIndex: 8 },
  { id: "mother", charId: "ma2", hanzi: "妈", pinyin: "mā", meaningPt: "mãe", category: "people", imageSrc: "people/mother.svg", imageAltPt: "Ilustração de uma mãe segurando um bebê no colo", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "neutral", subjectCount: 2, sceneTags: ["people", "family"], emoji: "👩‍🍼", afterUnitIndex: 8 },
  { id: "father", charId: "ba_dad", hanzi: "爸", pinyin: "bà", meaningPt: "pai", category: "people", imageSrc: "people/father.svg", imageAltPt: "Ilustração de um pai de mãos dadas com uma criança pequena", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "neutral", subjectCount: 2, sceneTags: ["people", "family"], emoji: "👨", afterUnitIndex: 11 },
  ...
  { id: "crowd", charId: "zhong3", hanzi: "众", pinyin: "zhòng", meaningPt: "multidão", category: "people", imageSrc: "people/crowd.svg", imageAltPt: "Ilustração de muitas pessoas reunidas", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "neutral", subjectCount: 7, sceneTags: ["people", "quantity"], emoji: "👥", afterUnitIndex: 8 },
  // ————— Natureza —————
  ...
  // ————— Animais —————
  { id: "horse", charId: "ma_horse", hanzi: "马", pinyin: "mǎ", meaningPt: "cavalo", category: "animals", imageSrc: "nature/horse.svg", imageAltPt: "Ilustração de um cavalo marrom de perfil em um campo", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "neutral", subjectCount: 1, sceneTags: ["nature", "animal"], emoji: "🐴", afterUnitIndex: 2 },
  { id: "fish", charId: "yu_fish", hanzi: "鱼", pinyin: "yú", meaningPt: "peixe", category: "animals", imageSrc: "daily-life/fish.svg", imageAltPt: "Ilustração de um peixe azul com bolhas de água", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "neutral", subjectCount: 1, sceneTags: ["food", "animal"], emoji: "🐟", afterUnitIndex: 12 },
  // ————— Comida e bebida —————
  { id: "rice", charId: "fan_rice", hanzi: "饭", pinyin: "fàn", meaningPt: "arroz", category: "food", imageSrc: "daily-life/rice.svg", imageAltPt: "Ilustração de uma tigela de arroz com hashi", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "neutral", subjectCount: 1, sceneTags: ["food", "meal"], emoji: "🍚", afterUnitIndex: 12 },
  { id: "tea", charId: "cha_tea", hanzi: "茶", pinyin: "chá", meaningPt: "chá", category: "food", imageSrc: "daily-life/tea.svg", imageAltPt: "Ilustração de uma xícara de chá verde soltando vapor", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "neutral", subjectCount: 1, sceneTags: ["food", "drink"], emoji: "🍵", afterUnitIndex: 12 },
  { id: "meat", charId: "rou_meat", hanzi: "肉", pinyin: "ròu", meaningPt: "carne", category: "food", imageSrc: "daily-life/meat.svg", imageAltPt: "Ilustração de um corte de carne em um prato", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "neutral", subjectCount: 1, sceneTags: ["food", "meal"], emoji: "🥩", afterUnitIndex: 12 },
  { id: "vegetables", charId: "cai_dish", hanzi: "菜", pinyin: "cài", meaningPt: "verdura", category: "food", imageSrc: "daily-life/vegetables.svg", imageAltPt: "Ilustração de verduras frescas com acelga e cenoura", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "neutral", subjectCount: 1, sceneTags: ["food", "meal"], emoji: "🥬", afterUnitIndex: 12 },
  ...
  // ————— Objetos e lugares —————
  { id: "book", charId: "shu_book", hanzi: "书", pinyin: "shū", meaningPt: "livro", category: "objects", imageSrc: "objects/book.svg", imageAltPt: "Ilustração de um livro aberto", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "neutral", subjectCount: 1, sceneTags: ["objects", "study"], emoji: "📖", afterUnitIndex: 12 },
  { id: "car", charId: "che", hanzi: "车", pinyin: "chē", meaningPt: "carro", category: "objects", imageSrc: "objects/car.svg", imageAltPt: "Ilustração de um carro vermelho visto de lado", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "neutral", subjectCount: 1, sceneTags: ["objects", "transport"], emoji: "🚗", afterUnitIndex: 12 },
  { id: "home", charId: "jia", hanzi: "家", pinyin: "jiā", meaningPt: "casa", category: "objects", imageSrc: "objects/home.svg", imageAltPt: "Ilustração de uma casa com telhado vermelho e chaminé", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "neutral", subjectCount: 1, sceneTags: ["objects", "place"], emoji: "🏠", afterUnitIndex: 11 },
  { id: "money", charId: "qian_money", hanzi: "钱", pinyin: "qián", meaningPt: "dinheiro", category: "objects", imageSrc: "objects/money.svg", imageAltPt: "Ilustração de uma nota de dinheiro com moedas douradas", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "neutral", subjectCount: 1, sceneTags: ["objects", "shopping"], emoji: "💰", afterUnitIndex: 12 },
  ...
  // ————— Quantidade —————
  { id: "one", charId: "yi", hanzi: "一", pinyin: "yī", meaningPt: "um", category: "quantity", imageSrc: "daily-life/one.svg", imageAltPt: "Ilustração de uma maçã vermelha", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "neutral", subjectCount: 1, sceneTags: ["quantity", "number"], emoji: "1️⃣", afterUnitIndex: 6 },
  { id: "two", charId: "er", hanzi: "二", pinyin: "èr", meaningPt: "dois", category: "quantity", imageSrc: "daily-life/two.svg", imageAltPt: "Ilustração de duas maçãs vermelhas", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "neutral", subjectCount: 2, sceneTags: ["quantity", "number"], emoji: "2️⃣", afterUnitIndex: 6 },
  { id: "three", charId: "san", hanzi: "三", pinyin: "sān", meaningPt: "três", category: "quantity", imageSrc: "daily-life/three.svg", imageAltPt: "Ilustração de três maçãs vermelhas", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "neutral", subjectCount: 3, sceneTags: ["quantity", "number"], emoji: "3️⃣", afterUnitIndex: 6 },
  { id: "four", charId: "si", hanzi: "四", pinyin: "sì", meaningPt: "quatro", category: "quantity", imageSrc: "daily-life/four.svg", imageAltPt: "Ilustração de quatro maçãs vermelhas", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "neutral", subjectCount: 4, sceneTags: ["quantity", "number"], emoji: "4️⃣", afterUnitIndex: 6 },
  { id: "five", charId: "wu", hanzi: "五", pinyin: "wǔ", meaningPt: "cinco", category: "quantity", imageSrc: "daily-life/five.svg", imageAltPt: "Ilustração de cinco maçãs vermelhas", imageKind: "illustration", visualStyle: "flat_illustration", backgroundStyle: "neutral", subjectCount: 5, sceneTags: ["quantity", "number"], emoji: "5️⃣", afterUnitIndex: 6 },
];
