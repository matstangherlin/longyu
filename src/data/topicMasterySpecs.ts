...
function defaultSpec(lesson: LessonForSpec): TopicMasterySpec {
  ...
  if (skill === "som") {
    return {
      ...
      passObjectives: {
        1: "Ouça e identifique o som-alvo.",
        2: "Compare dois sons próximos.",
        3: "Reconheça o contraste em uma palavra ou frase curta.",
        4: "Perceba e use o contraste em contexto.",
      },
