...
export const CHARACTERS: Character[] = [
  ...
  { id: "na_that", hanzi: "那", pinyin: "nà", toneless: "na", tone: 4, meaningPt: "aquilo; aquele, aquela", freqRank: 40, components: [] },
  { id: "li_inside", hanzi: "里", pinyin: "lǐ", toneless: "li", tone: 3, meaningPt: "interior; dentro; em", freqRank: 70, components: [] },
...
>>>>>>> 0f8c760 (Adiciona nova foto)
  ...
  { id: "yu_fish", hanzi: "鱼", pinyin: "yú", toneless: "yu", tone: 2, meaningPt: "peixe", freqRank: 913, components: [] },
  {
    ...
    toneless: "e",
    tone: 4,
    meaningPt: "com fome; faminto",
    freqRank: 1472,
    components: [],
    exampleWords: [{ hanzi: "我饿了", pinyin: "wǒ è le", pt: "estou com fome" }],
  },
  // --- Compras e dinheiro ---
  {
    id: "duo_many",
    ...
    toneless: "duo",
    tone: 1,
    meaningPt: "muito; mais",
    freqRank: 61,
    components: [],
    exampleWords: [{ hanzi: "多少钱？", pinyin: "duōshao qián?", pt: "quanto custa?" }],
  },
  {
    id: "shao_few",
    hanzi: "少",
