...
export const CHARACTERS: Character[] = [
  ...
  // --- China Real / endereco urbano ---
  { id: "lu_road", hanzi: "路", pinyin: "lù", toneless: "lu", tone: 4, meaningPt: "rua; avenida", freqRank: 930, components: [], exampleWords: [{ hanzi: "北京路", pinyin: "Běijīng lù", pt: "Beijing Road" }] },
  { id: "jie_street", hanzi: "街", pinyin: "jiē", toneless: "jie", tone: 1, meaningPt: "rua", freqRank: 931, components: [], exampleWords: [{ hanzi: "长安街", pinyin: "Cháng'ān jiē", pt: "Chang'an Avenue" }] },
  { id: "hao_number", hanzi: "号", pinyin: "hào", toneless: "hao", tone: 4, meaningPt: "número (endereço)", freqRank: 932, components: ["kou"], exampleWords: [{ hanzi: "10号", pinyin: "shí hào", pt: "número 10" }] },
  { id: "zuo_left", hanzi: "左", pinyin: "zuǒ", toneless: "zuo", tone: 3, meaningPt: "esquerda", freqRank: 933, components: [], exampleWords: [{ hanzi: "左边", pinyin: "zuǒbiān", pt: "lado esquerdo" }] },
  { id: "you_right", hanzi: "右", pinyin: "yòu", toneless: "you", tone: 4, meaningPt: "direita", freqRank: 934, components: [], exampleWords: [{ hanzi: "右边", pinyin: "yòubiān", pt: "lado direito" }] },
  { id: "qian_front", hanzi: "前", pinyin: "qián", toneless: "qian", tone: 2, meaningPt: "frente; antes", freqRank: 935, components: [], exampleWords: [{ hanzi: "前面", pinyin: "qiánmiàn", pt: "na frente" }] },
  { id: "hou_back", hanzi: "后", pinyin: "hòu", toneless: "hou", tone: 4, meaningPt: "atrás; depois", freqRank: 936, components: [], exampleWords: [{ hanzi: "后面", pinyin: "hòumiàn", pt: "atrás" }] },
  { id: "jin_near", hanzi: "近", pinyin: "jìn", toneless: "jin", tone: 4, meaningPt: "perto", freqRank: 937, components: ["chuo"] },
  { id: "yuan_far", hanzi: "远", pinyin: "yuǎn", toneless: "yuan", tone: 3, meaningPt: "longe", freqRank: 938, components: ["chuo"] },
  { id: "sheng_province", hanzi: "省", pinyin: "shěng", toneless: "sheng", tone: 3, meaningPt: "província", freqRank: 939, components: [], exampleWords: [{ hanzi: "广东省", pinyin: "Guǎngdōng shěng", pt: "província de Guangdong" }] },
  { id: "shi_city", hanzi: "市", pinyin: "shì", toneless: "shi", tone: 4, meaningPt: "cidade (unidade administrativa)", freqRank: 940, components: [], exampleWords: [{ hanzi: "北京市", pinyin: "Běijīng shì", pt: "município de Pequim" }] },
  { id: "qu_district", hanzi: "区", pinyin: "qū", toneless: "qu", tone: 1, meaningPt: "distrito", freqRank: 941, components: [] },
  {
