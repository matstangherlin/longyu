...
const CORE_PILOT_LEXICAL_TARGETS = {
  ...
  "p6-horarios": {
    ...
    vocabulary: [
      ...
      { ref: "chunk:badianban", hanzi: "八点半", pinyin: "ba dian ban", meaningPt: "oito e meia", role: "productive", introduceAtPass: 2 },
      { ref: "chunk:xianzai", hanzi: "现在", pinyin: "xianzai", meaningPt: "agora", role: "core", introduceAtPass: 1 },
      { ref: "chunk:jintian", hanzi: "今天", pinyin: "jintian", meaningPt: "hoje", role: "core", introduceAtPass: 2 },
      { ref: "chunk:mingtian", hanzi: "明天", pinyin: "mingtian", meaningPt: "amanha", role: "productive", introduceAtPass: 3 },
      { ref: "chunk:zuotian", hanzi: "昨天", pinyin: "zuotian", meaningPt: "ontem", role: "productive", introduceAtPass: 3 },
      { ref: "chunk:shenmeshihou", hanzi: "什么时候？", pinyin: "shenme shihou?", meaningPt: "quando?", role: "support", introduceAtPass: 2 },
