/** Copy comercial de Longyu for Business. Sem preços públicos e sem clientes fictícios. */

export const BUSINESS_SEO = {
  title: "Treinamento de Mandarim para Empresas | Longyu",
  description:
    "Longyu for Business: treinamento de mandarim para equipes que trabalham com a China. Adoção, progresso e competências — oferta comercial, sem checkout individual.",
  crawlerText:
    "Treinamento de mandarim para empresas e equipes Brasil–China. Longyu Business e Longyu Enterprise são ofertas comerciais: fale com vendas. Sem logotipos de clientes e sem preço público nesta versão.",
} as const;
...
export const BUSINESS_USE_CASES = [
  {
    title: "Indústria e automotivo",
    body: "Chão de fábrica, qualidade, peças, prazo e reunião com times na China.",
  },
  {
    title: "Energia, mineração e engenharia",
    body: "Vocabulário de segurança, medidas, fornecedores e acompanhamento de obra.",
  },
  {
    title: "Logística e comércio exterior",
    body: "Entrega, estoque, importação/exportação e comunicação com operadores chineses.",
  },
  {
    title: "Tecnologia e escritório",
    body: "Reuniões, e-mail, alinhamento de projeto e convívio com gestores chineses no Brasil.",
  },
] as const;

export const BUSINESS_STEPS = [
  {
    title: "1. Conversa comercial",
    body: "Objetivo, número de colaboradores e prazo. Sem cartão no site.",
  },
  {
    title: "2. Diagnóstico e piloto",
    body: "Um grupo pequeno, trilha combinada e relatório de acompanhamento.",
  },
  {
    title: "3. Contrato e implantação",
    body: "Assentos, papéis (admin, gestor, colaborador) e início do programa.",
  },
] as const;

export const BUSINESS_PLAN = {
  eyebrow: "Longyu Business",
  title: "Treinamento de mandarim para equipes",
  lead: "Para empresas que precisam de mandarim no trabalho — operação no Brasil com contato diário com a China, ou o inverso.",
  items: [
...
export const ENTERPRISE_PLAN = {
  ...
  items: [
    ...
    "Integrações com sistemas da empresa",
    "Suporte dedicado",
  ],
  footnote:
...
export const BUSINESS_FAQ = [
  ...
  },
  {
    ...
    a: "Sim, como perfil: operação local, gestores ou colegas chineses, necessidade real de mandarim no trabalho. Não listamos marcas como clientes sem autorização.",
  },
] as const;

export const BUSINESS_TRACKS_PREVIEW = [
  "Mandarim para Indústria",
  "Mandarim para Automotivo",
  "Mandarim para Engenharia",
  "Mandarim para Logística",
  "Mandarim para Comércio Exterior",
  "Mandarim para Escritório",
  "Mandarim para Viagens à China",
  "Mandarim para Relocation",
] as const;
