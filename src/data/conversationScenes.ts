...
sceneV2({
  ...
  entryNodeId: "taxi-1",
  nodes: [
    { id: "taxi-1", speakerId: "lin", hanzi: "你好。我要去酒店。", pinyin: "nǐ hǎo. wǒ yào qù jiǔdiàn.", pt: "Olá. Quero ir ao hotel.", nextNodeId: "taxi-2" },
    {
      id: "taxi-2",
      speakerId: "wang",
      hanzi: "去哪里？",
      ...
      interaction: {
        ...
        options: ["去北京路", "我要去酒店"],
        correctAnswer: "去北京路",
        correctNextNodeId: "taxi-4",
        wrongNextNodeId: "taxi-3",
        explanation: "去北京路 dá a rua. 我要去酒店 também leva ao hotel.",
      },
    },
    { id: "taxi-3", speakerId: "wang", hanzi: "好，去酒店。", pinyin: "hǎo, qù jiǔdiàn.", pt: "Certo, ao hotel.", nextNodeId: "taxi-4" },
    {
      id: "taxi-4",
      speakerId: "wang",
      hanzi: "好。多少钱？二十八。",
      pinyin: "hǎo. duōshao qián? èrshíbā.",
      pt: "Certo. Quanto custa? Vinte e oito.",
      interaction: {
        type: "choose_reply",
        prompt: "Pergunte o preço.",
        options: ["多少钱？", "再见", "谢谢", "我很好"],
        correctAnswer: "多少钱？",
        correctNextNodeId: "taxi-6",
        wrongNextNodeId: "taxi-5",
        explanation: "多少钱？ pergunta o preço.",
      },
    },
    { id: "taxi-5", speakerId: "wang", hanzi: "多少钱？请再说一遍。", pinyin: "duōshao qián? qǐng zài shuō yí biàn.", pt: "Quanto custa? Tente de novo.", emotion: "thinking", nextNodeId: "taxi-4" },
    { id: "taxi-6", speakerId: "lin", hanzi: "多少钱？", pinyin: "duōshao qián?", pt: "Quanto custa?", nextNodeId: "taxi-7" },
    {
      id: "taxi-7",
      speakerId: "wang",
      hanzi: "二十八。",
      ...
      interaction: {
        ...
        options: ["在这里停车", "再见", "谢谢", "我很好"],
        correctAnswer: "在这里停车",
        correctNextNodeId: "taxi-9",
        wrongNextNodeId: "taxi-8",
        explanation: "在这里停车 = pare aqui.",
      },
    },
    { id: "taxi-8", speakerId: "wang", hanzi: "在这里停车。请再说一遍。", pinyin: "zài zhèlǐ tíngchē. qǐng zài shuō yí biàn.", pt: "Pare aqui. Tente de novo.", emotion: "thinking", nextNodeId: "taxi-7" },
    { id: "taxi-9", speakerId: "lin", hanzi: "在这里停车。谢谢！", pinyin: "zài zhèlǐ tíngchē. xièxie!", pt: "Pare aqui. Obrigado!", nextNodeId: "taxi-10" },
    { id: "taxi-10", speakerId: "wang", hanzi: "好！", pinyin: "hǎo!", pt: "Certo!", emotion: "happy" },
  ],
  learnedRefs: [
    "chunk:nihao",
