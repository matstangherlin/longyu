...
import {
  IMERSAO_ESTACAO_LEARNED_REFS,
  IMERSAO_ESTACAO_NEW_REFS,
  IMERSAO_ESTACAO_NODES,
...
export const PAIR_LIN_MEI: ConversationCharacter[] = [
 ...
 */
export function sceneV2(scene: Omit<ConversationSceneStep, "kind" | "lines">): ConversationSceneStep {
...
sceneV2({
  ...
  nodes: IMERSAO_ESTACAO_NODES,
  learnedRefs: IMERSAO_ESTACAO_LEARNED_REFS,
  ...(IMERSAO_ESTACAO_NEW_REFS.length ? { newRefs: IMERSAO_ESTACAO_NEW_REFS } : {}),
  dedicatedLesson: true,
}),
sceneV2({
...
// ——— Grupos comunicativos: céu, casa, cardápio, livro, estação ———
sceneV2({
  sceneId: "comentar-ceu",
  title: "Olhando o céu",
  intent: "comment-sky",
  setting: "park",
  characters: PAIR_LIN_MEI,
  ...
  entryNodeId: "ceu-1",
  nodes: [
    { id: "ceu-1", speakerId: "mei", hanzi: "那是山。", pinyin: "nà shì shān.", pt: "Aquilo é uma montanha.", emotion: "happy", nextNodeId: "ceu-2" },
    {
      id: "ceu-2",
      speakerId: "lin",
      hanzi: "那是天？",
      ...
      interaction: {
        ...
        options: ["那是天", "那是山", "我很好", "再见"],
        correctAnswer: "那是天",
        correctNextNodeId: "ceu-4",
        wrongNextNodeId: "ceu-3",
        explanation: "那是天 aponta para o céu.",
      },
    },
    { id: "ceu-3", speakerId: "mei", hanzi: "天。请再说一遍。", pinyin: "tiān. qǐng zài shuō yí biàn.", pt: "Céu. Tente de novo.", emotion: "thinking", nextNodeId: "ceu-2" },
    { id: "ceu-4", speakerId: "lin", hanzi: "那是天。", pinyin: "nà shì tiān.", pt: "Aquilo é o céu.", emotion: "happy", nextNodeId: "ceu-5" },
    {
      id: "ceu-5",
      speakerId: "mei",
      hanzi: "今天很好！",
      ...
      interaction: {
        ...
        options: ["Hoje está ótimo.", "Aquilo é o céu.", "Estou bem.", "Até logo."],
        correctAnswer: "Hoje está ótimo.",
        correctNextNodeId: "ceu-7",
        wrongNextNodeId: "ceu-6",
        explanation: "今天很好 comenta o dia/clima de forma simples.",
      },
    },
    { id: "ceu-6", speakerId: "lin", hanzi: "今天很好。请再说一遍。", pinyin: "jīntiān hěn hǎo. qǐng zài shuō yí biàn.", pt: "Hoje está ótimo. Tente de novo.", emotion: "thinking", nextNodeId: "ceu-5" },
    { id: "ceu-7", speakerId: "lin", hanzi: "很好！", pinyin: "hěn hǎo!", pt: "Que bom!", emotion: "happy", nextNodeId: "ceu-8" },
    { id: "ceu-8", speakerId: "mei", hanzi: "再见！", pinyin: "zàijiàn!", pt: "Até logo!", emotion: "happy" },
  ],
  learnedRefs: [
    "char:shan",
    "chunk:nashitian",
...
sceneV2({
  sceneId: "esta-e-minha-casa",
  title: "Esta é minha casa",
  intent: "show-home",
  setting: "home",
  characters: PAIR_LIN_MEI,
  sceneRole: "common",
  entryNodeId: "casa-nova-1",
  nodes: [
    { id: "casa-nova-1", speakerId: "mei", hanzi: "你好！", pinyin: "nǐ hǎo!", pt: "Olá!", emotion: "happy", nextNodeId: "casa-nova-2" },
    { id: "casa-nova-2", speakerId: "lin", hanzi: "你好！这是我妈妈。", pinyin: "nǐ hǎo! zhè shì wǒ māma.", pt: "Olá! Esta é minha mãe.", emotion: "happy", nextNodeId: "casa-nova-3" },
    {
      id: "casa-nova-3",
      speakerId: "mei",
      hanzi: "这是什么？",
      ...
      interaction: {
        ...
        options: ["这是我家", "这是我妈妈", "我很好", "再见"],
        correctAnswer: "这是我家",
        correctNextNodeId: "casa-nova-5",
        wrongNextNodeId: "casa-nova-4",
        explanation: "这是我家 apresenta a casa da família.",
      },
    },
    { id: "casa-nova-4", speakerId: "mei", hanzi: "家。请再说一遍。", pinyin: "jiā. qǐng zài shuō yí biàn.", pt: "Casa. Tente de novo.", emotion: "thinking", nextNodeId: "casa-nova-3" },
    { id: "casa-nova-5", speakerId: "lin", hanzi: "这是我家。", pinyin: "zhè shì wǒ jiā.", pt: "Esta é minha casa.", emotion: "happy", nextNodeId: "casa-nova-6" },
    {
      id: "casa-nova-6",
      speakerId: "mei",
      hanzi: "好！你回家吗？",
      pinyin: "hǎo! nǐ huí jiā ma?",
      pt: "Certo! Você volta para casa?",
      interaction: {
        type: "choose_reply",
        prompt: "Confirme que vai para casa.",
        options: ["我回家", "这是我家", "我很好", "再见"],
        correctAnswer: "我回家",
        correctNextNodeId: "casa-nova-8",
        wrongNextNodeId: "casa-nova-7",
        explanation: "我回家 diz que você volta para casa.",
      },
    },
    { id: "casa-nova-7", speakerId: "mei", hanzi: "回家。请再说一遍。", pinyin: "huí jiā. qǐng zài shuō yí biàn.", pt: "Voltar para casa. Tente de novo.", emotion: "thinking", nextNodeId: "casa-nova-6" },
    { id: "casa-nova-8", speakerId: "lin", hanzi: "我回家。再见！", pinyin: "wǒ huí jiā. zàijiàn!", pt: "Vou para casa. Até logo!", emotion: "happy", nextNodeId: "casa-nova-9" },
    { id: "casa-nova-9", speakerId: "mei", hanzi: "再见！", pinyin: "zàijiàn!", pt: "Até logo!", emotion: "happy" },
  ],
  learnedRefs: [
    "chunk:nihao",
    "chunk:zheshimama",
...
sceneV2({
  sceneId: "pedir-cardapio",
  title: "Pedindo no cardápio",
  intent: "order-menu",
  setting: "shop",
  characters: PAIR_LIN_WANG,
  sceneRole: "module_review",
...
sceneV2({
  sceneId: "mostrar-livro",
  title: "Mostrando o livro",
  intent: "show-book",
  setting: "classroom",
  characters: PAIR_LIN_HUA,
  sceneRole: "common",
  entryNodeId: "livro-1",
  nodes: [
    { id: "livro-1", speakerId: "hua", hanzi: "你好！", pinyin: "nǐ hǎo!", pt: "Olá!", emotion: "happy", nextNodeId: "livro-2" },
    { id: "livro-2", speakerId: "lin", hanzi: "你好！", pinyin: "nǐ hǎo!", pt: "Olá!", emotion: "happy", nextNodeId: "livro-3" },
    {
      id: "livro-3",
      speakerId: "hua",
      hanzi: "这是什么？",
      ...
      interaction: {
        ...
        options: ["这是书", "这是水", "我很好", "再见"],
        correctAnswer: "这是书",
        correctNextNodeId: "livro-5",
        wrongNextNodeId: "livro-4",
        explanation: "这是书 identifica o livro.",
      },
    },
    { id: "livro-4", speakerId: "hua", hanzi: "书。请再说一遍。", pinyin: "shū. qǐng zài shuō yí biàn.", pt: "Livro. Tente de novo.", emotion: "thinking", nextNodeId: "livro-3" },
    { id: "livro-5", speakerId: "lin", hanzi: "这是书。", pinyin: "zhè shì shū.", pt: "Isto é um livro.", emotion: "happy", nextNodeId: "livro-6" },
    {
      id: "livro-6",
      speakerId: "hua",
      hanzi: "好！你看书吗？",
      pinyin: "hǎo! nǐ kàn shū ma?",
      pt: "Certo! Você lê o livro?",
      interaction: {
        type: "choose_reply",
        prompt: "Diga que você lê.",
        options: ["我看书", "太贵了", "多少钱？", "我很好"],
        correctAnswer: "我看书",
        correctNextNodeId: "livro-8",
        wrongNextNodeId: "livro-7",
        explanation: "我看书 diz que você lê / olha o livro.",
      },
    },
    { id: "livro-7", speakerId: "hua", hanzi: "看书。请再说一遍。", pinyin: "kàn shū. qǐng zài shuō yí biàn.", pt: "Ler. Tente de novo.", emotion: "thinking", nextNodeId: "livro-6" },
    { id: "livro-8", speakerId: "lin", hanzi: "我看书。谢谢！", pinyin: "wǒ kàn shū. xièxie!", pt: "Eu leio. Obrigado!", emotion: "happy", nextNodeId: "livro-9" },
    { id: "livro-9", speakerId: "hua", hanzi: "不客气！", pinyin: "bú kèqi!", pt: "De nada!", emotion: "happy" },
  ],
  learnedRefs: [
    "chunk:nihao",
    "chunk:zheshishenme",
...
sceneV2({
  sceneId: "onde-esta-o-carro",
  title: "Onde está o carro?",
  ...
  entryNodeId: "carro-1",
  nodes: [
    { id: "carro-1", speakerId: "lin", hanzi: "请问。", pinyin: "qǐng wèn.", pt: "Com licença.", emotion: "neutral", nextNodeId: "carro-2" },
    { id: "carro-2", speakerId: "wang", hanzi: "你好！", pinyin: "nǐ hǎo!", pt: "Olá!", emotion: "happy", nextNodeId: "carro-3" },
    {
      id: "carro-3",
      speakerId: "lin",
      hanzi: "车在哪里？",
      pinyin: "chē zài nǎlǐ?",
      pt: "Onde está o carro?",
      emotion: "thinking",
      interaction: {
        type: "choose_meaning",
        ...
        wrongNextNodeId: "carro-4",
        explanation: "车在哪里？ pergunta onde está o carro.",
      },
    },
    { id: "carro-4", speakerId: "wang", hanzi: "车。请再说一遍。", pinyin: "chē. qǐng zài shuō yí biàn.", pt: "Carro. Tente de novo.", emotion: "thinking", nextNodeId: "carro-3" },
    { id: "carro-5", speakerId: "wang", hanzi: "在那里。", pinyin: "zài nàlǐ.", pt: "Fica ali.", emotion: "happy", nextNodeId: "carro-6" },
    {
      id: "carro-6",
      speakerId: "wang",
      hanzi: "票多少钱？",
      pinyin: "piào duōshao qián?",
      pt: "Quanto custa o bilhete?",
      interaction: {
        type: "choose_reply",
        prompt: "Peça o bilhete.",
        options: ["我要票", "太贵了", "我很好", "再见"],
        correctAnswer: "我要票",
        correctNextNodeId: "carro-8",
        wrongNextNodeId: "carro-7",
        explanation: "我要票 pede o bilhete.",
      },
    },
    { id: "carro-7", speakerId: "wang", hanzi: "票。请再说一遍。", pinyin: "piào. qǐng zài shuō yí biàn.", pt: "Bilhete. Tente de novo.", emotion: "thinking", nextNodeId: "carro-6" },
    { id: "carro-8", speakerId: "lin", hanzi: "我要票。谢谢！", pinyin: "wǒ yào piào. xièxie!", pt: "Quero o bilhete. Obrigado!", emotion: "happy", nextNodeId: "carro-9" },
    { id: "carro-9", speakerId: "wang", hanzi: "不客气！再见！", pinyin: "bú kèqi! zàijiàn!", pt: "De nada! Até logo!", emotion: "happy" },
  ],
  learnedRefs: [
    "chunk:qingwen",
    "chunk:nihao",
...
sceneV2({
  sceneId: "falar-de-estudo",
  title: "Falar de estudo",
  intent: "study",
  setting: "school",
  characters: PAIR_LIN_HUA,
  sceneRole: "common",
  entryNodeId: "estudo-1",
  nodes: [
    {
      id: "estudo-1",
      speakerId: "hua",
      hanzi: "你好！你是学生吗？",
      pinyin: "nǐ hǎo! nǐ shì xuésheng ma?",
      pt: "Olá! Você é estudante?",
      emotion: "happy",
      interaction: {
        type: "choose_reply",
        prompt: "Como você responde que é estudante?",
        options: ["是，我是学生。", "再见", "谢谢", "我很好"],
        correctAnswer: "是，我是学生。",
        correctNextNodeId: "estudo-3",
        wrongNextNodeId: "estudo-2",
        explanation: "是，我是学生。 confirma o papel: sou estudante.",
      },
    },
    { id: "estudo-2", speakerId: "hua", hanzi: "请再说一遍：我是学生。", pinyin: "qǐng zài shuō yí biàn: wǒ shì xuésheng.", pt: "Tente de novo: sou estudante.", emotion: "thinking", nextNodeId: "estudo-1" },
    { id: "estudo-3", speakerId: "lin", hanzi: "是，我是学生。", pinyin: "shì, wǒ shì xuésheng.", pt: "Sim, sou estudante.", nextNodeId: "estudo-4" },
    {
      id: "estudo-4",
      speakerId: "hua",
      hanzi: "你学习什么？",
      pinyin: "nǐ xuéxí shénme?",
      pt: "O que você estuda?",
      interaction: {
        type: "choose_reply",
        prompt: "O que você estuda?",
        options: ["我学习中文", "我很好", "再见", "谢谢"],
        correctAnswer: "我学习中文",
        correctNextNodeId: "estudo-6",
        wrongNextNodeId: "estudo-5",
        explanation: "我学习中文 = eu estudo chinês.",
      },
    },
    { id: "estudo-5", speakerId: "hua", hanzi: "请再说一遍：我学习中文。", pinyin: "qǐng zài shuō yí biàn: wǒ xuéxí Zhōngwén.", pt: "Tente de novo: eu estudo chinês.", emotion: "thinking", nextNodeId: "estudo-4" },
    { id: "estudo-6", speakerId: "lin", hanzi: "我学习中文。", pinyin: "wǒ xuéxí Zhōngwén.", pt: "Eu estudo chinês.", nextNodeId: "estudo-7" },
    {
      id: "estudo-7",
      speakerId: "hua",
      hanzi: "你在哪里学习？",
      pinyin: "nǐ zài nǎlǐ xuéxí?",
      pt: "Onde você estuda?",
      interaction: {
        type: "choose_reply",
        prompt: "Onde você estuda?",
        options: ["我在学校学习", "我很好", "再见", "谢谢"],
        correctAnswer: "我在学校学习",
        correctNextNodeId: "estudo-9",
        wrongNextNodeId: "estudo-8",
        explanation: "我在学校学习 = eu estudo na escola.",
      },
    },
    { id: "estudo-8", speakerId: "hua", hanzi: "在学校。请再说一遍。", pinyin: "zài xuéxiào. qǐng zài shuō yí biàn.", pt: "Na escola. Tente de novo.", emotion: "thinking", nextNodeId: "estudo-7" },
    { id: "estudo-9", speakerId: "lin", hanzi: "我在学校学习。", pinyin: "wǒ zài xuéxiào xuéxí.", pt: "Eu estudo na escola.", nextNodeId: "estudo-10" },
    { id: "estudo-10", speakerId: "hua", hanzi: "好！谢谢！", pinyin: "hǎo! xièxie!", pt: "Ótimo! Obrigado!", emotion: "happy" },
  ],
  learnedRefs: [
    "chunk:nihao",
    "chunk:nishixueshengma",
    "chunk:shiwoshixuesheng",
    "chunk:nixuexishenme",
...
sceneV2({
  ...
  entryNodeId: "clima-1",
  nodes: [
    { id: "clima-1", speakerId: "mei", hanzi: "你好！", pinyin: "nǐ hǎo!", pt: "Olá!", emotion: "happy", nextNodeId: "clima-2" },
    {
      id: "clima-2",
      speakerId: "mei",
      hanzi: "今天天气怎么样？",
      ...
      interaction: {
        ...
        options: ["今天很热", "再见", "谢谢", "我很好"],
        correctAnswer: "今天很热",
        correctNextNodeId: "clima-4",
        wrongNextNodeId: "clima-3",
        explanation: "今天很热 = hoje está quente.",
      },
    },
    { id: "clima-3", speakerId: "mei", hanzi: "很热。请再说一遍。", pinyin: "hěn rè. qǐng zài shuō yí biàn.", pt: "Quente. Tente de novo.", emotion: "thinking", nextNodeId: "clima-2" },
    { id: "clima-4", speakerId: "lin", hanzi: "今天很热。", pinyin: "jīntiān hěn rè.", pt: "Hoje está quente.", nextNodeId: "clima-5" },
    {
      id: "clima-5",
      speakerId: "mei",
      hanzi: "下雨了？",
      ...
      interaction: {
        ...
        options: ["下雨了", "再见", "谢谢", "我很好"],
        correctAnswer: "下雨了",
        correctNextNodeId: "clima-7",
        wrongNextNodeId: "clima-6",
        explanation: "下雨了 = está chovendo.",
      },
    },
    { id: "clima-6", speakerId: "mei", hanzi: "下雨了。请再说一遍。", pinyin: "xià yǔ le. qǐng zài shuō yí biàn.", pt: "Está chovendo. Tente de novo.", emotion: "thinking", nextNodeId: "clima-5" },
    { id: "clima-7", speakerId: "lin", hanzi: "下雨了。", pinyin: "xià yǔ le.", pt: "Está chovendo.", nextNodeId: "clima-8" },
    { id: "clima-8", speakerId: "mei", hanzi: "好。今天天气很好？不太好。", pinyin: "hǎo. jīntiān tiānqì hěn hǎo? bú tài hǎo.", pt: "Certo. O tempo está ótimo? Não muito.", emotion: "thinking" },
  ],
  learnedRefs: [
    "chunk:nihao",
...
sceneV2({
  ...
  sceneRole: "common",
  entryNodeId: "taxi-1",
  nodes: PEGAR_TAXI_NODES,
  learnedRefs: PEGAR_TAXI_LEARNED_REFS,
}),
// RC2.2.9 — express_preference não tinha nenhuma conversa em runtime. A cena
// tem intenção (Mei oferece), reação (também gosta / não gosta), progressão
// (a proposta muda por causa da preferência) e fechamento. Só usa palavras já
// ensinadas até l28; é dedicada, então só entra onde é chamada.
sceneV2({
  sceneId: "gostos-na-casa",
  ...
  nodes: [
    {
      ...
      pt: "Você gosta de beber chá?",
      interaction: {
        type: "choose_reply",
        prompt: "Mei quer saber se você gosta de chá. Você gosta. Responda.",
        options: ["我喜欢茶", "我不喜欢肉", "再见", "多少钱"],
        correctAnswer: "我喜欢茶",
        correctNextNodeId: "gosto-3",
        wrongNextNodeId: "gosto-2",
        explanation: "我喜欢茶 = eu gosto de chá.",
      },
    },
    { id: "gosto-2", speakerId: "mei", hanzi: "请再说一遍。你喜欢茶吗？", pinyin: "qǐng zài shuō yí biàn. nǐ xǐhuan chá ma?", pt: "Repita, por favor. Você gosta de chá?", emotion: "confused", nextNodeId: "gosto-1" },
    { id: "gosto-3", speakerId: "lin", hanzi: "我喜欢茶。", pinyin: "wǒ xǐhuan chá.", pt: "Eu gosto de chá.", emotion: "happy", nextNodeId: "gosto-4" },
    {
      id: "gosto-4",
      speakerId: "mei",
      hanzi: "我也喜欢茶！你喜欢吃肉吗？",
      pinyin: "wǒ yě xǐhuan chá! nǐ xǐhuan chī ròu ma?",
      pt: "Eu também gosto de chá! Você gosta de comer carne?",
      emotion: "happy",
      interaction: {
        type: "choose_reply",
        prompt: "Você não gosta de carne. Diga isso a Mei.",
        options: ["我不喜欢肉", "我喜欢肉", "我要一杯茶", "谢谢"],
        correctAnswer: "我不喜欢肉",
        correctNextNodeId: "gosto-6",
        wrongNextNodeId: "gosto-5",
        explanation: "我不喜欢肉 = eu não gosto de carne. 不 vem antes de 喜欢.",
      },
    },
    { id: "gosto-5", speakerId: "mei", hanzi: "你喜欢肉吗？请再说一遍。", pinyin: "nǐ xǐhuan ròu ma? qǐng zài shuō yí biàn.", pt: "Você gosta de carne? Repita, por favor.", emotion: "thinking", nextNodeId: "gosto-4" },
    { id: "gosto-6", speakerId: "lin", hanzi: "我不喜欢肉。", pinyin: "wǒ bù xǐhuan ròu.", pt: "Eu não gosto de carne.", nextNodeId: "gosto-7" },
    {
      id: "gosto-7",
      speakerId: "mei",
      hanzi: "好，我们吃米饭吧！",
      pinyin: "hǎo, wǒmen chī mǐfàn ba!",
      pt: "Tudo bem, vamos comer arroz!",
      emotion: "happy",
      interaction: {
        type: "choose_reply",
        prompt: "Mei muda a proposta por sua causa. Aceite e agradeça.",
        options: ["好！谢谢！", "我不喜欢肉", "再见", "我很好"],
        correctAnswer: "好！谢谢！",
        correctNextNodeId: "gosto-9",
        wrongNextNodeId: "gosto-8",
        explanation: "好！谢谢！ aceita a proposta e agradece.",
      },
    },
    { id: "gosto-8", speakerId: "mei", hanzi: "米饭，好吗？", pinyin: "mǐfàn, hǎo ma?", pt: "Arroz, pode ser?", emotion: "thinking", nextNodeId: "gosto-7" },
    { id: "gosto-9", speakerId: "lin", hanzi: "好！谢谢！", pinyin: "hǎo! xièxie!", pt: "Ótimo! Obrigado!", emotion: "happy", nextNodeId: "gosto-10" },
    { id: "gosto-10", speakerId: "mei", hanzi: "不客气！", pinyin: "bú kèqi!", pt: "De nada!", emotion: "happy" },
  ],
  learnedRefs: ["chunk:woxihuan", "chunk:woyeshi", "chunk:nihaoma", "chunk:woxianghe", "chunk:woxiangchimifan", "chunk:woyaomifan", "chunk:woyaorou", "chunk:xiexie", "chunk:bukeqi", "chunk:qingzaishuoyibian", "chunk:womenzouba"],
}),
// RC2.2.9 — ask_directions não tinha conversa em que o ALUNO pede o caminho
// (nas cenas de estação, quem fala as direções é o personagem). Aqui o aluno
// pergunta, entende a instrução e agradece. Dedicada: só entra em p6-direcoes.
sceneV2({
  sceneId: "perguntar-o-caminho",
  title: "Como chego ao metrô?",
  intent: "ask-route",
  setting: "street",
  characters: PAIR_LIN_WANG,
  sceneRole: "common",
  dedicatedLesson: true,
  entryNodeId: "caminho-1",
  nodes: [
    { id: "caminho-1", speakerId: "lin", hanzi: "你好！请问。", pinyin: "nǐ hǎo! qǐng wèn.", pt: "Olá! Com licença.", nextNodeId: "caminho-2" },
    {
      id: "caminho-2",
      speakerId: "wang",
      hanzi: "你好！",
      ...
      interaction: {
        ...
        options: ["地铁站怎么走？", "我坐地铁", "地铁站", "再见"],
        correctAnswer: "地铁站怎么走？",
        correctNextNodeId: "caminho-4",
        wrongNextNodeId: "caminho-3",
        explanation: "地铁站怎么走？ = como chego à estação de metrô?",
      },
    },
    { id: "caminho-3", speakerId: "wang", hanzi: "请再说一遍。你去哪里？", pinyin: "qǐng zài shuō yí biàn. nǐ qù nǎlǐ?", pt: "Repita, por favor. Para onde você vai?", emotion: "confused", nextNodeId: "caminho-2" },
    { id: "caminho-4", speakerId: "lin", hanzi: "地铁站怎么走？", pinyin: "dìtiězhàn zěnme zǒu?", pt: "Como chego à estação de metrô?", nextNodeId: "caminho-5" },
    {
      id: "caminho-5",
      speakerId: "wang",
      hanzi: "一直走，左转。",
      pinyin: "yìzhí zǒu, zuǒ zhuǎn.",
      pt: "Siga em frente e vire à esquerda.",
      interaction: {
        type: "choose_meaning",
        prompt: "O que Wang mandou você fazer?",
        options: ["Seguir em frente e virar à esquerda", "Virar à direita", "Voltar para o hotel", "Pegar um táxi"],
        correctAnswer: "Seguir em frente e virar à esquerda",
        correctNextNodeId: "caminho-7",
        wrongNextNodeId: "caminho-6",
        explanation: "一直走 = siga em frente; 左转 = vire à esquerda.",
      },
    },
    { id: "caminho-6", speakerId: "wang", hanzi: "一直走。左转。", pinyin: "yìzhí zǒu. zuǒ zhuǎn.", pt: "Em frente. Depois, à esquerda.", emotion: "thinking", nextNodeId: "caminho-5" },
    {
      id: "caminho-7",
      speakerId: "wang",
      hanzi: "地铁站在左边。",
      pinyin: "dìtiězhàn zài zuǒbiān.",
      pt: "A estação fica à esquerda.",
      interaction: {
        type: "choose_reply",
        prompt: "Agradeça pela ajuda.",
        options: ["谢谢！", "太贵了", "我不喜欢", "多少钱"],
        correctAnswer: "谢谢！",
        correctNextNodeId: "caminho-9",
        wrongNextNodeId: "caminho-8",
        explanation: "谢谢 agradece pela informação.",
      },
    },
    { id: "caminho-8", speakerId: "wang", hanzi: "地铁站在左边。请再说一遍？", pinyin: "dìtiězhàn zài zuǒbiān. qǐng zài shuō yí biàn?", pt: "A estação fica à esquerda. Como disse?", emotion: "thinking", nextNodeId: "caminho-7" },
    { id: "caminho-9", speakerId: "lin", hanzi: "谢谢！", pinyin: "xièxie!", pt: "Obrigado!", emotion: "happy", nextNodeId: "caminho-10" },
    { id: "caminho-10", speakerId: "wang", hanzi: "不客气！", pinyin: "bú kèqi!", pt: "De nada!", emotion: "happy" },
  ],
  learnedRefs: ["chunk:nihao", "chunk:qingwen", "chunk:ditiezhan", "chunk:zenmezou", "chunk:yizhizou", "chunk:zuozhuan", "chunk:zuobian", "chunk:zaina", "chunk:woqubeijing", "chunk:xiexie", "chunk:bukeqi", "chunk:qingzaishuoyibian"],
}),
];
