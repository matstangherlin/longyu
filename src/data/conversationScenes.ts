...
sceneV2({
  ...
  nodes: [
    ...
    { id: "cardapio-2", speakerId: "wang", hanzi: "你好！", pinyin: "nǐ hǎo!", pt: "Olá!", emotion: "happy", nextNodeId: "cardapio-3" },
    {
      id: "cardapio-3",
      speakerId: "wang",
      hanzi: "你要饭吗？",
      pinyin: "nǐ yào fàn ma?",
      pt: "Você quer arroz?",
      emotion: "thinking",
      interaction: {
        type: "choose_reply",
        prompt: "Escolha arroz (não verdura).",
        options: ["我要饭", "我要菜", "再见", "我很好"],
        correctAnswer: "我要饭",
        correctNextNodeId: "cardapio-5",
        wrongNextNodeId: "cardapio-4",
        explanation: "我要饭 pede arroz / a refeição.",
      },
    },
    { id: "cardapio-4", speakerId: "wang", hanzi: "饭。请再说一遍。", pinyin: "fàn. qǐng zài shuō yí biàn.", pt: "Arroz. Tente de novo.", emotion: "thinking", nextNodeId: "cardapio-3" },
    { id: "cardapio-5", speakerId: "lin", hanzi: "我要饭。", pinyin: "wǒ yào fàn.", pt: "Quero arroz.", nextNodeId: "cardapio-6" },
    {
      id: "cardapio-6",
      speakerId: "wang",
      hanzi: "你要菜吗？",
      pinyin: "nǐ yào cài ma?",
      pt: "Você quer verdura?",
      interaction: {
        type: "choose_reply",
        prompt: "Aceite a verdura também.",
        options: ["我要菜", "再见", "我很好", "我要饭"],
        correctAnswer: "我要菜",
        correctNextNodeId: "cardapio-8",
        wrongNextNodeId: "cardapio-7",
        explanation: "我要菜 pede verdura / um prato.",
      },
    },
    { id: "cardapio-7", speakerId: "wang", hanzi: "菜。请再说一遍。", pinyin: "cài. qǐng zài shuō yí biàn.", pt: "Verdura. Tente de novo.", emotion: "thinking", nextNodeId: "cardapio-6" },
    { id: "cardapio-8", speakerId: "lin", hanzi: "我要菜。", pinyin: "wǒ yào cài.", pt: "Quero verdura.", nextNodeId: "cardapio-9" },
    {
      id: "cardapio-9",
      speakerId: "wang",
      hanzi: "你要肉吗？",
      pinyin: "nǐ yào ròu ma?",
      pt: "Você quer carne?",
      interaction: {
        type: "choose_reply",
        prompt: "Prefira peixe à carne.",
        options: ["我要鱼", "我要肉", "我很好", "再见"],
        correctAnswer: "我要鱼",
        correctNextNodeId: "cardapio-11",
        wrongNextNodeId: "cardapio-10",
        explanation: "我要鱼 pede peixe; 我要肉 pediria carne.",
      },
    },
    { id: "cardapio-10", speakerId: "wang", hanzi: "鱼。请再说一遍。", pinyin: "yú. qǐng zài shuō yí biàn.", pt: "Peixe. Tente de novo.", emotion: "thinking", nextNodeId: "cardapio-9" },
    { id: "cardapio-11", speakerId: "lin", hanzi: "我要鱼。", pinyin: "wǒ yào yú.", pt: "Quero peixe.", nextNodeId: "cardapio-12" },
    {
      id: "cardapio-12",
      speakerId: "wang",
      hanzi: "你想喝水吗？",
      ...
      interaction: {
        type: "choose_reply",
        prompt: "Diga o que quer beber.",
        options: ["我想喝水", "我要鱼", "再见", "我很好"],
        correctAnswer: "我想喝水",
        correctNextNodeId: "cardapio-14",
        wrongNextNodeId: "cardapio-13",
        explanation: "我想喝水 diz o que você quer beber.",
      },
    },
    { id: "cardapio-13", speakerId: "wang", hanzi: "喝水。请再说一遍。", pinyin: "hē shuǐ. qǐng zài shuō yí biàn.", pt: "Beber água. Tente de novo.", emotion: "thinking", nextNodeId: "cardapio-12" },
    { id: "cardapio-14", speakerId: "lin", hanzi: "我想喝水。谢谢！", pinyin: "wǒ xiǎng hē shuǐ. xièxie!", pt: "Quero beber água. Obrigado!", emotion: "happy", nextNodeId: "cardapio-15" },
    { id: "cardapio-15", speakerId: "wang", hanzi: "不客气！再见！", pinyin: "bú kèqi! zàijiàn!", pt: "De nada! Até logo!", emotion: "happy" },
  ],
  learnedRefs: [
    "chunk:woele",
    "chunk:womenchifanba",
