...
function StepTone({ step, onDone, onSkip, onMistake }: StepProps) {
  ...
  return (
    <div className="text-center">
      ...
      <div className="mx-auto my-4 grid max-w-md gap-3 sm:max-w-xl sm:grid-cols-[112px_1fr] sm:items-start">
        <button
          onClick={play}
  ...
  return (
    <div>
      ...
      <div className="my-6 flex min-h-[92px] flex-wrap items-center justify-center gap-2 rounded-[24px] border border-dashed border-accent-soft bg-surface-2/80 p-4 shadow-inner">
        {picked.length === 0 && <span className="w-full text-center text-sm font-medium text-ink-faint">Toque nas peças abaixo</span>}
  ...
  return (
    <div>
      ...
      {(isOpen && step.productionHintPt) && (
        <p className="mt-2 text-sm text-ink-soft">{step.productionHintPt}</p>
      )}
