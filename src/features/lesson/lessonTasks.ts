...
function makeTransferStep(
  ...
  return {
    ...
    transferComponentHanzi: task.transferComponentHanzi,
    transferComponentPt: task.transferComponentPt,
    transferChallengePt: task.transferChallengePt,
    transferSafePatternPt: task.transferSafePatternPt,
