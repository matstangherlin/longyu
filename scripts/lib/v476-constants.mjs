...
export const V476_SECRET_CATALOG = [
  ...
  { name: "STRIPE_PRICE_PRO_MONTHLY_BR", kind: "test_mode_only" },
  { name: "STRIPE_PRICE_PRO_MONTHLY_INTERNATIONAL", kind: "test_mode_only" },
  { name: "STRIPE_PRICE_PRO_ANNUAL_BR", kind: "test_mode_only" },
  { name: "STRIPE_PRICE_PRO_ANNUAL_INTERNATIONAL", kind: "test_mode_only" },
  { name: "STRIPE_PRICE_FAMILY_MONTHLY_BR", kind: "test_mode_only" },
  { name: "STRIPE_PRICE_FAMILY_MONTHLY_INTERNATIONAL", kind: "test_mode_only" },
  { name: "STRIPE_PRICE_FAMILY_ANNUAL_BR", kind: "test_mode_only" },
  { name: "STRIPE_PRICE_FAMILY_ANNUAL_INTERNATIONAL", kind: "test_mode_only" },
