...
const MUTATIONS = {
  "android-safe-area": [
    ...
    ["DF7. intro de permissões sem safe-area", "MODAL_SAFE_AREA_MISSING", src("intro", "pb-[calc(var(--app-safe-bottom,0px)+1.25rem)]", "pb-5")],
  ...
  "native-permissions": [
    ...
    ["DK9. microfone antes das notificações", "PERMISSION_ORDER", src("intro", "      await requestNotificationPermission();\n      await requestNativeMicrophone();", "      await requestNativeMicrophone();\n      await requestNotificationPermission();")],
    ["DK10. recusa trava o intro", "DENIAL_BLOCKS_APP", src("intro", "    } finally {\n      setWorking(false);\n      finish();\n    }", "    } catch {\n      setWorking(false);\n    }")],
    ["DK11. intro na Web", "INTRO_NOT_GATED", src("bootstrap", "if (!android || introVersion >= NATIVE_PERMISSION_INTRO_VERSION) return null;", "if (introVersion >= NATIVE_PERMISSION_INTRO_VERSION) return null;")],
  ...
  "streak-notifications": [
    ...
    ["DL11. toque fora da allowlist", "DEEP_LINK_NOT_ALLOWED", src("reminderPlan", 'REMINDER_URL_COMEBACK = "com.longyu.app://revisao"', 'REMINDER_URL_COMEBACK = "com.longyu.app://admin"')],
