...
assert(storeSrc.includes("version: 24"), "persist v24 Native Culture Lessons + Culture teaching loop + Culture Quest + Topic Mastery Path + entitlement cloud efêmero");
assert(
