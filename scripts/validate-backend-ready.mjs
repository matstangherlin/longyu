...
console.log("  3. supabase secrets set STRIPE_SECRET_KEY=... STRIPE_WEBHOOK_SECRET=... e os oito STRIPE_PRICE_<PLANO>_<CICLO>_<MERCADO> (node scripts/set-stripe-price-secrets.mjs)");
