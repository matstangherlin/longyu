...
const MUTATIONS = {
  "mobile-landing-focus": [
    ...
    ["DY4. rótulo do teste guiado some", "GUIDED_TRY_CTA_MISSING", src("ptBR", 'ctaGuidedTry: "Fazer teste guiado · 3 min"', 'ctaGuidedTry: "Começar"')],
    ...
    ["DY7. seletor de idioma volta ao cabeçalho do celular", "LANDING_LANGUAGE_CONTROL", src("welcome", "<BrandLockup size={34} />", "<BrandLockup size={34} />\n          <LanguageSwitcher compact id=\"landing-interface-locale\" />")],
    ["DY10. logo oficial (mascote) trocado por emoji no cabeçalho", "BRAND_MISSING", src("welcome", "<BrandLockup size={34} />", "<span>🐉 Longyu</span>")],
  ...
  "guided-learning-try": [
    ...
    ["DZ10. teste com 11 passos", "GUIDED_STEPS_RANGE", src("guided", '["intro", "listen", "explain", "tone", "meaning", "build", "conversation"]', '["intro", "listen", "explain", "tone", "meaning", "build", "conversation", "q2", "q3", "q4", "q5"]')],
    ...
    ["DZ12. teste cria aluno", "GUIDED_PERSISTS", src("guided", "  function playNihao() {", "  function playNihao() {\n    createAccount(\"Visitante\");")],
    ["DZ13. fim leva direto à Jornada", "GUIDED_END_MISSING", src("guided", 'navigate("/comecar");\n  }', 'navigate("/jornada");\n  }')],
