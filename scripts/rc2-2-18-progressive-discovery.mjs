...
const MUTATIONS = {
  ...
  "guidance-orchestrator": [
    ...
    ["15. dispensar ignorado", "DISMISS_IGNORED", src("orchestrator", '    else records[id] = { status: "SEEN", at: now };', "    else void 0;")],
  ...
  "navigation-disclosure": [
    ...
    ["26. área re-tranca no carregamento do sync", "FEATURE_RELOCKS_DURING_SYNC", src("hook", "return mergeStickyVisibility(derived, confirmed);", "return derived;")],
  ...
  "discovery-release": [
    ...
    ["M59. evento com PII", "ANALYTICS_PII", src("host", "{ guidance_id: fresh.definition.id, kind: fresh.definition.kind }", '{ guidance_id: fresh.definition.id, kind: fresh.definition.kind, email: "x" }')],
