 ...
 *
 * Gera o plano REAL de cada lição e falha se a repetição semântica
 * viola os limites pedagógicos (mesma resposta, intenção, tripla cognitiva, etc.).
 */
...
async function main() {
  ...
  try {
    ...
    for (const lesson of lessons) {
      ...
      planCount += 1;
      const issues = lessonNoveltyIssues(lesson, plan);
