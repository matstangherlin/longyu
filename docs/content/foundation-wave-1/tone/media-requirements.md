# O que são tons? — requisitos de mídia
...
| --- | --- | --- |
| `foundation-tone-pt-v1.mp4` | pt-BR | **NONE** |
| `foundation-tone-en-v1.mp4` | en | **NONE** |
...
- Áudio em mandarim: não há trecho falado nesta aula.
