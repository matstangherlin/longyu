...
| Gerado em | 2026-08-14T00:25:59.066Z |
| Lições | 127 |
...
Meta mínima da remessa V3.3: **35** lições migradas. Meta ideal: **40**.

## Cobertura por categoria

| Categoria | Total | Mastery | Cobertura % |
|-----------|------:|--------:|-------------:|
| Fundamentos (`foundation`) | 18 | 16 | 88.9% |
| Vida cotidiana (`daily-life`) | 12 | 11 | 91.7% |
| Viagem (`travel`) | 2 | 2 | 100% |
| China Real (`china-real`) | 6 | 6 | 100% |
| Survival Mandarin (`survival`) | 1 | 1 | 100% |
| Intermediário (`intermediate`) | 7 | 4 | 57.1% |
| Revisão (`review`) | 4 | 0 | 0% |
| **Subtotal (categorias aplicáveis)** | **50** | **40** | **80%** |

## Visão geral da Jornada

- Total de lições na Jornada: **127**
- Lições com `masteryLoop: true`: **40**
- Categorias não elegíveis (sound-lab/hanzi-lab/system): **67**
- Meta mínima (35) atingida ✅
- Meta ideal (40) atingida ✅

## Detalhe por lição

| Categoria | Lição | Status classificado | Mastery real |
|-----------|-------|----------------------|---------------|
...
| review | `l14-char-rev` | review-special | — |
| review | `p4-checkpoint-fundamentos` | review-special | — |
| review | `l19-logica-rev` | review-special | — |
| review | `l10-rev` | review-special | — |

<!-- integridade:677afbfdca78b803 -->
